 ...
 */
public class Dip {
    private static final int STAR_LIMIT = 10;
    ...
    public static Dip generateRandomDip() {
        ...
        for (int i = 0; i < MAX_STARS; ) {
            int candidate = generator.nextInt(STAR_LIMIT-1) + 1;
