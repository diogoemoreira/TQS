...
public class SetOfNaturalsTest {
    ...
    //add(), fromArray(), size(), intersects(), contains()

    @Test
    @DisplayName("No duplicates should be allowed")
    ...
    public void fromArrayTest(){
        ...
        SetOfNaturals testSet2 = new SetOfNaturals();
        for (int i = 1; i < 6; i++) {
            testSet2.add(i);
        }
        assertEquals(testSet2, SetOfNaturals.fromArray(testArray));
    }

    @Test
    public void InvalidFromArrayTest(){
        int[] testArray = {1,2,3,4,5,5};
        assertThrows(IllegalArgumentException.class, () -> SetOfNaturals.fromArray(testArray));
    }
